---
name: vault-cleanup
description: Prepare vault for safe GitHub push by removing or redacting sensitive data. Use this skill before pushing to GitHub, when the user says "cleanup vault", "prepare for github", "safe to push", or wants to check if vault is safe to share. Scans and redacts PII from Needs_Action/, Pending_Approval/, and Logs/ folders.
---

# vault-cleanup

Prepare vault for safe GitHub push by removing or redacting sensitive data.
